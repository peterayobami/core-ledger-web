...
export function ReportKpi({ label, value, hint, icon: Icon, tone = "primary" }: Readonly<ReportKpiProps>) {
    return (
...
export function ReportKpiStrip({ children }: Readonly<{ children: ReactNode }>) {
...
}: Readonly<{ tone?: KpiTone; children: ReactNode }>) {
    return (
        <span className={cn(
