...
import { formatNGN, totalAA, taxComputation } from "@/lib/services/ca.service";
...
function ComputationView({ year, preview }: { year: ReturnType<typeof caRepository.getByFiscalYear> & {}; preview?: boolean }) {
