                        ...
                        <ClCard>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div className="min-w-0">
                                    ...
                                    <span className="cl-tag mt-1">{customer.type}</span>
                                </div>
                            </div>
                            <div className="mt-3 space-y-1.5 text-xs">
                                <div className="flex items-start gap-2 text-muted-foreground"><MapPin className="h-3.5 w-3.5 mt-0.5 shrink-0" /><span className="break-words">{customer.address}</span></div>
                                <div className="flex items-center gap-2 text-primary"><Mail className="h-3.5 w-3.5 shrink-0" /><span>{customer.email}</span></div>
                                <div className="flex items-center gap-2 text-primary"><Phone className="h-3.5 w-3.5 shrink-0" /><span>{customer.phone}</span></div>
                            </div>
                        </ClCard>
