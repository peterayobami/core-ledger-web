...
import { abbr, MoneyTooltip } from "@/lib/utils/chart-helpers";
...
export default function CashFlowPage() {
  ...
  if (ob.openingCash === 0) {
    missing.push({
      field: `Opening Cash for FY${year} has not been set.`,
          ...
          <div>
            ...
            <div className="mt-3 p-3 rounded-md bg-secondary/50 border border-border text-[12px] text-muted-foreground flex items-start gap-2">
              ...
              <span>
                ...
                <Link href="/books/journals" className="text-primary font-medium hover:underline inline-flex items-center gap-0.5">
